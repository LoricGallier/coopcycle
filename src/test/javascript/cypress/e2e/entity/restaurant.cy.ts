...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { name: 'd', restaurantAdresse: 'Cambridgeshire' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      ...
      cy.get(`[data-cy="restaurantAdresse"]`)
        .type('Buckinghamshire lavender tangible')
        .should('have.value', 'Buckinghamshire lavender tangible');
