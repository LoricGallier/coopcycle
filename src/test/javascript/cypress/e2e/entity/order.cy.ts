...
describe('Order e2e test', () => {
  ...
  const orderSample = { orderDate: '2023-04-08T20:49:13.155Z', orderStatus: 'PRETE', price: 63387 };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="orderDate"]`).type('2023-04-08T16:37').blur().should('have.value', '2023-04-08T16:37');

      cy.get(`[data-cy="orderStatus"]`).select('PREPARATION');

      cy.get(`[data-cy="price"]`).type('58821').should('have.value', '58821');
