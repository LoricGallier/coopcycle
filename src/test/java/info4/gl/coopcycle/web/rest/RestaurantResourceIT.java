...
class RestaurantResourceIT {
    ...
    private static final String DEFAULT_RESTAURANT_ADRESSE = "AAAAAAAAAA";
    private static final String UPDATED_RESTAURANT_ADRESSE = "BBBBBBBBBB";
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).restaurantAdresse(DEFAULT_RESTAURANT_ADRESSE);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).restaurantAdresse(UPDATED_RESTAURANT_ADRESSE);
        return restaurant;
    }
    ...
    void createRestaurant() throws Exception {
        ...
        assertThat(testRestaurant.getRestaurantAdresse()).isEqualTo(DEFAULT_RESTAURANT_ADRESSE);
    }
    ...
    @Test
    @Transactional
    void checkRestaurantAdresseIsRequired() throws Exception {
        int databaseSizeBeforeTest = restaurantRepository.findAll().size();
        // set the field null
        restaurant.setRestaurantAdresse(null);
    ...
    void getAllRestaurants() throws Exception {
        ...
        restRestaurantMockMvc
            ...
            .andExpect(jsonPath("$.[*].restaurantAdresse").value(hasItem(DEFAULT_RESTAURANT_ADRESSE)));
    }
    ...
    void getRestaurant() throws Exception {
        ...
        restRestaurantMockMvc
            ...
            .andExpect(jsonPath("$.restaurantAdresse").value(DEFAULT_RESTAURANT_ADRESSE));
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).restaurantAdresse(UPDATED_RESTAURANT_ADRESSE);
        ...
        assertThat(testRestaurant.getRestaurantAdresse()).isEqualTo(UPDATED_RESTAURANT_ADRESSE);
    }
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).restaurantAdresse(UPDATED_RESTAURANT_ADRESSE);
