...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderDate(DEFAULT_ORDER_DATE).orderStatus(DEFAULT_ORDER_STATUS).price(DEFAULT_PRICE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderDate(UPDATED_ORDER_DATE).orderStatus(UPDATED_ORDER_STATUS).price(UPDATED_PRICE);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderDate(UPDATED_ORDER_DATE).orderStatus(UPDATED_ORDER_STATUS).price(UPDATED_PRICE);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).price(UPDATED_PRICE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).orderStatus(UPDATED_ORDER_STATUS).price(UPDATED_PRICE);
