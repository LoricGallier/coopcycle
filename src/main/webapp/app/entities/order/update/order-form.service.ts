...
type OrderFormDefaults = Pick<NewOrder, 'id' | 'orderDate' | 'plats'>;
...
type OrderFormGroupContent = {
  ...
  price: FormControl<OrderFormRawValue['price']>;
  plats: FormControl<OrderFormRawValue['plats']>;
  client: FormControl<OrderFormRawValue['client']>;
  restaurant: FormControl<OrderFormRawValue['restaurant']>;
  livreur: FormControl<OrderFormRawValue['livreur']>;
};
